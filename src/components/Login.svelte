...
<div class="card p-6 space-y-6 shadow-xl">
	...
	<div class="flex justify-between flex-wrap">
		<p class="text-sm unstyled py-2 text-slate-500">
			Don't have an account? <a class="anchor" href="/">Register</a>
		</p>
